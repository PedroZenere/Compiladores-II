...
def corpo():
  ...
  if ch == 'begin':
    ...
    if ch == 'end':
      ...
      raise Exception('Esperado encontrar ' + '"end"' + ' Mas encontrado: ' + ch)

  else:
    raise Exception('Esperado encontrar ' + '"begin"' + ' Mas encontrado: ' + ch)
# Ok
...
def dc_v():
  ...
  if ch == 'var':
    ...
    raise Exception('Esperado um identificador de variável ' + '"var"' + ' válido. Mas encontrado: ' + ch)
# Ok
...
def tipo_var():
  ...
  if(ch == 'integer'):
      ...
      raise Exception('Esperado um tipo ' + '"integer ou real"' + ' Mas encontrado: ' + ch)
# Ok
...
def dc_p():
  ...
  if ch == 'procedure':
    ...
    raise Exception('Esperado um identificador de procedimento ' + '"procedure"' + ' válido. Mas encontrado: ' + ch)
# Ok
...
def lista_arg():
  ...
  if ch == '(':
    ...
    if ch == ')':
      ...
      raise Exception('Esperado encontrar ' + '")"' + ' Mas encontrado: ' + ch)
  # Ok
  ...
  if ch == 'read':
    ...
    if ch == 'do':
      ...
      if ch == '$':
        ...
        raise Exception('Esperado o simbolo ' + '"$"' + ' Mas encontrado: ' + ch)
    else:
      raise Exception('Esperado o comando ' + '"do"' + ' Mas encontrado: ' + ch)
    ...
    if ch == 'then':
      ...
      raise Exception('Esperado o comando ' + '"then"' + ' Mas encontrado: ' + ch)
...
def relacao():
  ...
  if ch in operador_relacional:
    ...
    raise Exception('Esperado encontrar um operador relacional valido. Mas encontrado: ' + ch)
    # Ok
